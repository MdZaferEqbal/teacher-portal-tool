...
@section('main-section')
    <div class="container ">
        ...
        <h5 class="text-center text-danger">
            ...
            <a href="https://github.com/MdZaferEqbal/teacher-portal-tool" target="_blank" class="btn btn-outline-dark m-2"><i class="fa-brands fa-github"></i>&nbsp;<i class="fa-brands fa-git"></i></a>
        </h5>
    </div>
@endsection
